...
void UCI::loop() {
    ...
    do
    {
        ...
        if (token == "CS433")
            cs433_project(pos, states, is, limits);
...
void UCI::cs433_project(Stockfish::Position &pos, Stockfish::StateListPtr &states, std::istringstream& is,Search::LimitsType limits){
