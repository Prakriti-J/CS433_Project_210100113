...
class UCI {
   ...
   private:
    ...
    void cs433_project(Stockfish::Position &pos, Stockfish::StateListPtr &states,std::istringstream& is, Search::LimitsType limits);
    Move find_next_move(Stockfish::Position &pos, Stockfish::StateListPtr &states);
};
